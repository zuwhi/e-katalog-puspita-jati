...
class ProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print(authController.userAccount.value!.toJson());

    final TextEditingController nameController = TextEditingController(
        text: authController.userAccount.value!.name ?? "");
    final TextEditingController alamatController = TextEditingController(
        text: authController.userAccount.value!.alamat ?? "");
    final TextEditingController phoneController = TextEditingController(
        text: authController.userAccount.value!.telepon ?? "");
    return Obx(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            child: ClipRRect(
                                ...
                                child: authController.imageProfile.value != null
                                    ? Image.file(
                                        authController.imageProfile.value!,
                                        fit: BoxFit.cover,
                                      )
                                    : authController.userAccount.value!.image !=
                                            null
                                        ? CachedNetworkImage(
